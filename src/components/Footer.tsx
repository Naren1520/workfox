        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Decentralized freelance platform powered by Algorand blockchain.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/developers" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Developers
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="https://developer.algorand.org" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Algorand Docs
                </a>
              </li>
              <li>
